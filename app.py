...
with tab1:
    ...
    if df_plot_storm.empty:
        ...
        fig1.update_layout(mapbox_style="satellite-streets", mapbox_zoom=6, mapbox_center={"lat": 24.4, "lon": 54.6}, margin={"r":0,"t":0,"l":0,"b":0})
        ...
        fig1 = px.scatter_mapbox(df_plot_storm, lat="Latitude", lon="Longitude", color="Storm Probability", size="Marker Size",
                                mapbox_style="satellite-streets", zoom=6, color_continuous_scale=["#10B981", "#F59E0B", "#EF4444", "#7F1D1D"], range_color=[0, 100])
...
with tab2:
    ...
    if df_plot_heat.empty:
        ...
        fig2.update_layout(mapbox_style="satellite-streets", mapbox_zoom=6, mapbox_center={"lat": 24.4, "lon": 54.6}, margin={"r":0,"t":0,"l":0,"b":0})
        ...
        fig2 = px.scatter_mapbox(df_plot_heat, lat="Latitude", lon="Longitude", color="Temperature", size="Node Size",
                                mapbox_style="satellite-streets", zoom=6, color_continuous_scale=["#FDE047", "#F97316", "#DC2626", "#450A0A"], range_color=[40, 60])
...
with tab3:
    ...
    fig3 = px.scatter_mapbox(df_time, lat="Latitude", lon="Longitude", color="Dust Probability", size="Dust Node",
                            ...
                            mapbox_style="satellite-streets", zoom=6, 
